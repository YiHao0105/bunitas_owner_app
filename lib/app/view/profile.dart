                          ...
                          Obx(() => Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                value.subType == "Products Only" ? Container() :InkWell(
                                  onTap: () {
                                    value.onServices();
                                  },
                                  child: _buildList(
                                      Icons.access_time, 'Treatments'.tr),
                                ),
                                value.subType == "Products Only" ? Container() :  InkWell(
                                  onTap: () {
                                    value.onPackages();
                                ...
                                value.subType == "Products Only" ? Container() : InkWell(
                                  ...
                                  child: _buildList(
                                      Icons.access_time, 'Availability'.tr),
                                ),
                               //Commented by GeekTech
                                ...
                                value.subType == "Products Only" ? Container() : value.type == true
                                    ? InkWell(
                                  onTap: () {
                                    value.onStylist();
                                  },
                                ...
                                value.haveShop.value == "1"
                                  ...
                                  child: _buildList(Icons.list_alt,
                                      'Manage Products'.tr),
                                )
                                    : const SizedBox(),
                                ...
                                InkWell(
                                  ...
                                  child: _buildList(
                                      Icons.history, 'Order History'.tr),
                                ),
                                InkWell(
                                  onTap: () {
                                    value.onReview();
                                ...
                                InkWell(
                                  ...
                                  child:
                                  _buildList(Icons.language, 'Policy'.tr),
                                ),
                                InkWell(
                                  onTap: () {
                                    value.onLanguages();
