                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          RichText(
                                                                            text:
                                                                              ...
                                                                              children: [
                                                                                TextSpan(
                                                                                  text: value.currencySide == 'left' ? value.currencySymbol + value.productSalonList[index].orders![subIndex].originalPrice.toString() : value.productSalonList[index].orders![subIndex].originalPrice.toString() + value.currencySymbol,
                                                                                ...
                                                                                const TextSpan(text: ' '),
                                                                                TextSpan(
                                                                                  text: value.currencySide == 'left' ? value.currencySymbol + value.productSalonList[index].orders![subIndex].sellPrice.toString() : value.productSalonList[index].orders![subIndex].sellPrice.toString() + value.currencySymbol,
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          RichText(
                                                                            text:
                                                                              ...
                                                                              children: [
                                                                                TextSpan(
                                                                                  text: value.currencySide == 'left' ? value.currencySymbol + value.productSalonListOld[index].orders![subIndex].originalPrice.toString() : value.productSalonListOld[index].orders![subIndex].originalPrice.toString() + value.currencySymbol,
                                                                                  style: const TextStyle(fontSize: 10, color: ThemeProvider.blackColor, fontFamily: 'regular', decoration: TextDecoration.lineThrough),
                                                                                ),
                                                                                const TextSpan(text: ' '),
                                                                                TextSpan(
                                                                                  text: value.currencySide == 'left' ? value.currencySymbol + value.productSalonListOld[index].orders![subIndex].sellPrice.toString() : value.productSalonListOld[index].orders![subIndex].sellPrice.toString() + value.currencySymbol,
                                                                                  style: const TextStyle(fontSize: 10, color: ThemeProvider.blackColor, fontFamily: 'regular'),
                                                                                ),
                                                                              ],
                                                                            ),
