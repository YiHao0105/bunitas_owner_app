                                          ...
                                          children: [
                                            ...
                                            SizedBox(
                                              ...
                                              child: ElevatedButton(
                                                ...
                                                onPressed: () {
                                                  value.onEditTime(value.getDayName(value.timesList[index].day as int), value.timesList[index].openTime.toString(), value.timesList[index].closeTime.toString(),index);
                                                },
                                                child: Text(
                                                  'Edit'.tr,
...
selectImage(ProfileCategoriesController value, BuildContext context, String type) {
