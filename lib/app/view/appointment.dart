                                        ...
                                        Banner(
                                          message: value
                                              .statusName[value
                                                  ...
                                                  .status as int]
                                              .tr,
                                          color:  value.statusName[value
                                              .appointmentListOld[index].status as int].tr ==  "Accepted".tr ? ThemeProvider.greenColor
                                              : value.statusName[value.appointmentListOld[index].status as int].tr ==  "Ongoing".tr  ?   ThemeProvider.orangeColor
                                              : value.statusName[value.appointmentListOld[index].status as int].tr ==  "Completed".tr  ?   ThemeProvider.purpleColor
                                              : value.statusName[value.appointmentListOld[index].status as int].tr ==  "Delayed".tr  ?   ThemeProvider.yellowColor
                                              : value.statusName[value.appointmentListOld[index].status as int].tr ==  "Rejected".tr  ?   ThemeProvider.redColor
