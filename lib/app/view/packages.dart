                                          ...
                                          RichText(
                                            text: TextSpan(
                                              children: [
                                                item.discount != 0.0
                                                    ? TextSpan(
                                                        text: Get.find<PackagesController>()
                                                                    .currencySide ==
                                                                'left'
                                                            ? '${Get.find<PackagesController>().currencySymbol}${item.price}'
                                                            : ' ${item.price}${Get.find<PackagesController>().currencySymbol}',
                                                        style: const TextStyle(
                                                            fontSize: 12,
                                                            color: ThemeProvider
                                                                .greyColor,
                                                ...
                                                TextSpan(
                                                  text: item.discount != 0.0
                                                      ? Get.find<PackagesController>()
                                                                  .currencySide ==
                                                              'left'
                                                          ? '${Get.find<PackagesController>().currencySymbol}${item.off}'
                                                          : '  ${item.off}${Get.find<PackagesController>().currencySymbol}'
                                                      : '',
                                                  style: const TextStyle(
                                                      fontSize: 12,
                                                      color: ThemeProvider
