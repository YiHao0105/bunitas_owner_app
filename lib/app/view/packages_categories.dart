                                              ...
                                              RichText(
                                                text: TextSpan(
                                                  children: [
                                                    ...
                                                    TextSpan(
                                                      text:Get.find<PackagesCategoriesController>().currencySide == 'left' ?
                                                      '${Get.find<PackagesCategoriesController>().currencySymbol}${value.servicesList[i].price}'
                                                       :'${value.servicesList[i].price}${Get.find<PackagesCategoriesController>().currencySymbol}'   ,
                                                      style: const TextStyle(
                                                          fontSize: 12,
                                                          color: ThemeProvider
                                                              .greenColor,
                                                    ...
                                                    TextSpan(
                                                      text: Get.find<PackagesCategoriesController>().currencySide == 'left' ?
                                                      '${Get.find<PackagesCategoriesController>().currencySymbol}${value.servicesList[i].off}':
                                                      '${value.servicesList[i].off}${Get.find<PackagesCategoriesController>().currencySymbol}',
                                                      style: const TextStyle(
                                                          fontSize: 12,
                                                          color: ThemeProvider
                                                              .greyColor,
