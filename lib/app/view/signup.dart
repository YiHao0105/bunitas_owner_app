                            ...
                            Container(
                              ...
                              child: ClipOval(
                                child: GestureDetector(
                                  onTap: () {
                                    chooseFile(context, value, "profile");
                                  },
                                  child: Image.network(
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                            ...
                            child: Container(
                              ...
                              child: SizedBox(
                                ...
                                child: DropdownButton<String>(
                                  ...
                                  hint: Text(value.selectedGender),
                                  isExpanded: true,
                          ...
                          Container(
                            ...
                            child: SizedBox(
                              ...
                              child: DropdownButton<String>(
                                iconDisabledColor: ThemeProvider.appColor,
                                iconEnabledColor: ThemeProvider.appColor,
                                hint: Text(value.selectedService),

                                isExpanded: true,
                                underline: const SizedBox(),
                                style: TextStyle(color: Colors.deepPurple),
                                onChanged: (newValue) {
                                  if (newValue == "Hair & Nails Salon") {
                                    value.updateType(1);
                                  } else if (newValue == 'Mobile Beautician') {
                                    value.updateType(0);
                                  } else if (newValue == 'Barber Shop') {
                                    value.updateType(2);
                                  } else if (newValue == 'Wellness & Spa') {
                                    value.updateType(3);
                                  } else if (newValue == 'Beauty Clinics') {
                                    value.updateType(4);
                                  } else if (newValue == 'Products Only') {
                                    value.updateType(5);
                                  }
                                  value.selectedService = newValue.toString();
                                },
                                // onChanged: (String newValue) {
                                //   // setState(() {
                          ...
                          Container(
                            ...
                            child: SizedBox(
                              ...
                              child: DropdownButton<String>(
                                iconDisabledColor: ThemeProvider.appColor,
                                iconEnabledColor: ThemeProvider.appColor,
                                hint: Text(value.isBusinessRegistered),
                          ...
                          Visibility(
                            visible: value.isBusinessRegistered == "Yes"
                                ? true
                                : false,
                            child: Container(
                              padding: const EdgeInsets.symmetric(vertical: 8),
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    border: InputBorder.none,
                                    labelText:
                                        "Business Registration Number".tr,
                                  ),
                                ),
                              ),
                            ),
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: List.generate(
                                        ...
                                        (index) => Text(value
                                            .servedCategoriesList[index].name
                                            .toString())),
                                  )
                                ],
                              ),
                          ...
                          Container(
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                ...
                                onTap: () {
                                  chooseFile(
                                      context, value, "beautyCertificate");
                                },
                              ),
                            ),
                          ),
