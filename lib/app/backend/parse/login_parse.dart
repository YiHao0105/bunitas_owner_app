...
class LoginParser {
  ...
  void saveInfo(String id, String firstName, String lastName, String cover,
      String email, String mobile, String type,String subType) {
    ...
    sharedPreferencesManager.putString('subType', subType);
  }

  void saveOtherInfo(String name, String cover, String background,
      double rating, String totalRating,String inHome,String haveShop,String saloonId) {
    print("HelloBackgroundImage====>"+background.toString());
    ...
    sharedPreferencesManager.putString('in_home', inHome);
    sharedPreferencesManager.putString('have_shop', haveShop);
    sharedPreferencesManager.putString('saloonId', saloonId);
  }
