...
class IndividualProfileController extends GetxController
  ...
  IndividualProfileController({required this.sharedPreferencesManager,required this.parser});
      ...
      if (response.statusCode == 200) {
        ...
        if (response.body['data'] != null && response.body['data'] != '') {
          ...
          if (body['image_name'] != null && body['image_name'] != '') {
            ...
            debugPrint("HelloBackgroundImage===>"+backgroundCover);
            update();
          }
        }
      } else {
  ...
  Future<void> updateIndividual() async {
    ...
    if (response.statusCode == 200) {
      ...
      sharedPreferencesManager.putString('background', backgroundCover);
  ...
  void updateSalonTime(int dayNumber, String openTime, String closeTime,
      int listIndex) {
    debugPrint(dayNumber.toString() + " " + openTime.toString() + closeTime);
    // var index = _timesList.indexWhere((element) => element.day == dayNumber);
    bool flag = false;
