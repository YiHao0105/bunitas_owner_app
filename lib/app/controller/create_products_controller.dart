...
class CreateProductsController extends GetxController implements GetxService {
  ...
  Future<void> getProductById() async {
    ...
    if (response.statusCode == 200) {
      ...
      sellPriceTextEditor.text = _productsInfo.discount == 0.0 ? "" : _productsInfo.sellPrice.toString() ;
      discountTextEditor.text = _productsInfo.discount == 0.0 ? "" : _productsInfo.discount.toString() ;
  ...
  Future<void> updateProduct() async {
    ...
    var body = {
      ...
      // "sell_price": sellPriceTextEditor.text.isEmpty ? 0 : sellPriceTextEditor.text,
      "sell_price": discountTextEditor.text.isEmpty ?  productsPriceTextEditor.text : sellPriceTextEditor.text,
    ...
    print("HelloProductPrice====>"+body.toString());
