...
class AddPackagesController extends GetxController implements GetxService {
  ...
  Future<void> onSave() async {
    ...
    var body = {
      ...
      "off": discountTextEditor.text.isEmpty  ? priceTextEditor.text : sellPriceTextEditor.text ,
    ...
    print("HelloPackage====> "+body.toString());
  ...
  Future<void> getById() async {
    ...
    print("helloPackageDetail===>"+response.bodyString.toString());
    if (response.statusCode == 200) {
      ...
      sellPriceTextEditor.text = _packagesInfo.discount.toString() == "0.0" ? "" : _packagesInfo.off.toString();
      discountTextEditor.text = _packagesInfo.discount.toString() == '0.0' ? "" : _packagesInfo.discount.toString() ;
