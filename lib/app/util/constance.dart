...
class AppConstants {
  ...
  static const String getSelectedCategories = 'api/v1/category_type/getByTreatmentId';

  //static const String getSelectedCategories = 'api/v1/category_type/getById';
  ...
  static const String updatePolicy = 'api/v1/salon/updatePolicy';
  static const String getPolicy = 'api/v1/salon/getPolicy';
  static const String getMySelectedCategory = 'api/v1/salon/getMySelectedCategory';
  static const String getSelectedIndividualCategory = 'api/v1/individual/getMySavedCategory';
  // API Routes
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: '', languageName: 'Français', countryCode: 'FR', languageCode: 'fr'),
    LanguageModel(imageUrl: '', languageName: 'Polski', countryCode: 'PL', languageCode: 'pl'),
    LanguageModel(imageUrl: '', languageName: 'Русский', countryCode: 'RU', languageCode: 'ru'),
    LanguageModel(imageUrl: '', languageName: 'বাংলা', countryCode: 'BD', languageCode: 'bd'),
    LanguageModel(imageUrl: '', languageName: 'اردو', countryCode: 'PK', languageCode: 'ur'),
  ];
}
