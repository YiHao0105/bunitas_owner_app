...
class MainBinding extends Bindings {
  ...
  Future<void> dependencies() async {
    ...
    Get.lazyPut(() => PolicyParser(apiService: Get.find(), sharedPreferencesManager: Get.find()), fenix: true);
    ...
    Get.lazyPut(() => TreatmentCategoriesParser(apiService: Get.find(), sharedPreferencesManager: Get.find()), fenix: true);
